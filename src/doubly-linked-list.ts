...
export class DoublyLinkedList<T> {
  ...
  static from<T> (...values: T[]): DoublyLinkedList<T>
  static from<T> (...values: T[] | T[][]): DoublyLinkedList<T> {
   ...
   * @returns {*}
   */
  find (predicate: (node: Node<T>, index: number, linkedList: DoublyLinkedList<T>) => unknown): Node<T> | undefined
  find<S extends T> (predicate: (node: Node<T>, index: number, linkedList: DoublyLinkedList<T>) => node is Node<S>): S | undefined
  find (predicate: (node: Node<T>, index: number, linkedList: DoublyLinkedList<T>) => unknown): Node<T> | undefined {
